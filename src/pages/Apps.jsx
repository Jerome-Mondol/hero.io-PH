      ...
      <div className="bg-dark min-h-screen">
        <div>
          ...
          <div className="flex justify-between items-center py-5 w-[80%] mx-auto">
            ...
            <input type="text" placeholder="Search apps" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-[60%] sm:w-[40%] px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-violet-500 text-dark"
            />
          </div>
